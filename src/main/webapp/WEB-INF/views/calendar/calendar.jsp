...
<body>
	<div id="whiteBoard">
		<div id="calendarOwner">${ sessionScope.loginMember.name }의일정</div>
		<table id="calendar" align="center" border="1"
			...
			<c:forEach items="${ requestScope.calendarList }" var="calendar">
				<input type="hidden" id="gavedStartDate" value="${ calendar.startDate }">
				<input type="hidden" id="gavedEndDate" value="${ calendar.endDate }">
				<input type="hidden" id="gavedTitle" value="${ calendar.title }">
			</c:forEach>
	...
	<div id="management-create-modal">
		<div class="modal_content">
			<form id="scheduleCreateForm"
				action="${ pageContext.servletContext.contextPath }/calendar/regist"
				method="post">
				<div class="modal_head">
					<h3>일정 생성</h3>
				</div>
				<div class="modal_content-box">
					<input type="text" class="managementModalInput title" name="title" placeholder="Meeting Log Title" required="required"> <br>
					<input type='date' class="managementModalDateInput start-day" name='startDate' id="startDate" required="required" /> 
					<input type='date' class="managementModalDateInput end-day" name='endDate' id="endDate" required="required" /> 
					...
					<input type="hidden" name="memberName" value="${ sessionScope.loginMember.name }"> <br>
					<textarea class="managementModalInput content" name="body" rows="13" cols="51" placeholder="상세내용을 입력해주세요"></textarea>
				</div>
				<div class="modal_button">
					<button type="button" id="calendar-create">Ok</button>
	...
	<div id="management-create-modal2">
		<div class="modal_content">
			<form action="" method="post">
				...
				<div class="modal_content-box">
					<input type="text" class="managementModalInput title" name="managementTitle" placeholder="Meeting Log Title"> <br>
					<input type='date' class="managementModalDateInput start-day" name='taskStartday' /> 
					<input type='date' class="managementModalDateInput end-day" name='taskEndday' /> <br>
					<textarea class="managementModalInput content" name="managementNum" rows="13" cols="51" placeholder="상세내용을 입력해주세요"></textarea>
				</div>
				<div class="modal_button">
					<button type="button" id="calendar-create2">Ok</button>
   ...
   document.getElementById("calendar-create").onclick = function() {
	   ...
	   if(startDate.value > endDate.value) {
		   ...
		   document.getElementById("scheduleCreateForm").submit();
	   }
   }
  ...
  function buildCalendar(){//현재 달 달력 만들기
		...
		// 1일이 시작되는 칸을 맞추어 줌
		 for (i=0; i<doMonth.getDay(); i++) {  //-> 오호 1일 맞춰주기 위해서 그거구나!(비어있는 그거!)
		 /*이번달의 day만큼 돌림*/
